#ifndef __LINEAR_FACTOR_METHOD_H__
#define __LINEAR_FACTOR_METHOD_H__
 ...
 * executing the lm regression on pairs of snps, this
 * versions treats the SNPs as factor variables instead of
 * ordinals.
 */
class lm_factor_method
: public method_type
{
public:
    /**
     ...
     */
    lm_factor_method(method_data_ptr data);
...
#endif /* End of __LINEAR_FACTOR_METHOD_H__ */
